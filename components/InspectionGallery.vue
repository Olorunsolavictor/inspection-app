...
<template>
  <div class="p-4 max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-2xl font-bold text-gray-800">Inspection Gallery</h2>
      <div>
        <Button variant="filled" size="sm" @click="clearGallery">
          Clear all</Button
        >
      </div>
    </div>
    ...
    >
      <div
        ...
        :key="index"
        class="rounded-lg pb-4 shadow hover:shadow-md transition overflow-hidden"
      >
